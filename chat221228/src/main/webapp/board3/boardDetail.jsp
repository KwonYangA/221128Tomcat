	...
	function boardDelView(){
		alert("boardDelView호출 성공");
		  $('#d_boardDel').dialog({
			    ...
			    closed: true,
			    cache: false,
			    href: 'boardDeleteForm.jsp?bm_no=<%=bm_no%>',
			    modal: true
	   });
...
<body>
	...
	<table align="center" id="p" class="easyui-panel" title="글상세보기"
		...
		<tr>
			<td>비밀번호</td>
			<td><input id="bm_pw" value="<%=bm_pw%> name="
				bm_pw" class="easyui-passwordbox"></td>
		</tr>
	</table>
	...
	<!-- 글삭제 시작 -->
	<div id="d_boardDel" closed="true" class="easyui-dialog"
		style="padding: 20px 50px">
		<div id="btn_boardDel" align="right">
			<a href="javascript:boardDel()" class="easyui-linkbutton"
				iconCls="icon-ok" style="width: 90px">확인</a> <a
				href="javascript:boardDelClose()" class="easyui-linkbutton"
				iconCls="icon-cancel" style="width: 90px">닫기</a>
		</div>
	</div>
	<!-- 글삭제  끝   -->
	<!-- 글수정 시작 -->
	<div id="d_boardUpd" closed="true" class="easyui-dialog"
		style="padding: 20px 50px">
		<form id="uf_board" method="get">
			...
			<table align="center" width="650px" height="280px">
				<tr>
					...
					<td width="580px"><input id="bm_title" value="<%=bm_title%>"
						name="bm_title" class="easyui-textbox"></td>
				</tr>
				<tr>
					<td width="120px">작성자</td>
					<td width="580px"><input id="bm_writer" value="<%=bm_writer%>"
						name="bm_writer" class="easyui-textbox"></td>
				</tr>
				<tr>
					<td width="120px">내용</td>
					<td width="580px"><input id="bm_content" multiline="true"
						value="<%=bm_content%>" name="bm_content" class="easyui-textbox"
				...
				<tr>
					...
					<td width="580px"><input id="bm_pw" name="bm_pw"
						class="easyui-textbox" style="width: 100px"></td>
				</tr>
			</table>
		</form>
		<div id="btn_boardUpd" align="right">
			<a href="javascript:boardUpd()" class="easyui-linkbutton"
				iconCls="icon-ok" style="width: 90px">등록</a> <a
				href="javascript:boardUpdClose()" class="easyui-linkbutton"
				iconCls="icon-cancel" style="width: 90px">닫기</a>
		</div>
	</div>
	<!-- 글수정  끝  -->
