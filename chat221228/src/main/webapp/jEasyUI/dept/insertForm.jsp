...
<body>
 <div style="margin:20px 0;"></div>
  <div style="margin:30px">
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="dname" label="부서명:" labelPosition="top" data-options="prompt:'Enter a 부서명'" style="width:200px;">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="loc" label="지역:" labelPosition="top" data-options="prompt:'Enter a 지역'" style="width:200px;">
        </div>
        <div style="text-align:center">
            <a href="javascript:insertAction()" class="easyui-linkbutton" iconCls="icon-ok" style="width:100px;height:32px">등록</a>
        </div>
        </form>
        </div>
 	...
 	const insertAction=()=>{
 		...
 		$.ajax({
 			...
 			console.log(xhrObject.resposeText)	
 			}
 		})
 	}
 </script>
