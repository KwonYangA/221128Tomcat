...
public class Board3Controller implements Controller3 {
	...
	//quill editor에서 이미지 선택하면 업로드처리 - 물리적인 위치 - 톰캣서버 - chat221228 -webapp-pds
	...
	public Object imageUpload(HttpServletRequest req, HttpServletResponse res) {
		...
		String realFolder = "C:\\Users\\user1\\Desktop\\tomcat\\chat221228\\src\\main\\webapp\\pds";
		//첨부파일의 한글처리
		...
		try {
			...
			//@param1 - req 요청 - body에 담김 - 단위 테스트불가
	...
	//Quill Editor -위지웤 기능 첨가 <p></p><img..../> PNG, JPG, JPEG
	...
	public Object imageGet(HttpServletRequest req, HttpServletResponse res) {
		...
		String filePath = "C:\\Users\\user1\\Desktop\\tomcat\\chat221228\\src\\main\\webapp\\pds"; // 절대경로.	
		String fname = b_file;
