...
public class HandlerMapping {
	 ...
	 * @return Object
	 *******************************************************************************/
	static Logger logger = Logger.getLogger(Board3Controller.class);
	...
	public static Object getController(String[] upmu, HttpServletRequest req, HttpServletResponse res)
		...
		if("common".equals(upmu[0])) {
			...
			if ("boardList".equals(upmu[1])) {// html화면 출력이 나감- text/html
			...
			} else if ("boardDetail".equals(upmu[1])) {// json포맷으로 나감 - application/json
				...
				logger.info("boardInsert==> boolean :" + obj instanceof String);
				// 리턴타입이 ModelAndView
